  ...
  return (
    <div className={styles.project1Page}>
      ...
      <Section marginBottom="xl" padding="none" className={styles.heroContent}>
            <Typography variant="h1" className={styles.heroTitle}>Sketchbook</Typography>
    ...
    <Section marginBottom="xl" padding="none">
        <ImageGrid>
          ...
          <div className={styles.imageContainer}>
            <Image src={beachscape} alt="Image 2" className={styles.gridImage} />
          </div>
          <div className={styles.imageContainer}>
            <Image src={countryscape} alt="Image 3" className={styles.gridImage} />
          </div>
          <div className={styles.imageContainer}>
            <Image src={desertscape} alt="Image 4" className={styles.gridImage} />
          </div>
          <div className={styles.imageContainer}>
            <Image src={junglescape} alt="Image 5" className={styles.gridImage} />
          </div>
          <div className={styles.imageContainer}>
            <Image src={winterscape} alt="Image 6" className={styles.gridImage} />
          </div>
        </ImageGrid>
      </Section>
